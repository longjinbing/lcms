...
public class RedisUtils {
    ...
    public static void clearDaoCache(){
      Set<Object> keys=  redisTemplate.keys(Constant.DAO_CACHE_NAME+"::*");
      redisTemplate.delete(keys);
    }

    public static void clearSecurityCache(){
        Set<Object> keys=  redisTemplate.keys(Constant.SECURITY_CACHE_NAME+"::*");
        redisTemplate.delete(keys);
    }

    public static void clearServiceCache(){
        Set<Object> keys=  redisTemplate.keys(Constant.SERVICE_CACHE_NAME+"::*");
        redisTemplate.delete(keys);
    }

    public static void clearDaoByPattern(String pattern){
        Set<Object> keys=  redisTemplate.keys(Constant.DAO_CACHE_NAME+"*"+pattern+"*");
        redisTemplate.delete(keys);
    }

    public static void clearDaoByDaoClass(Class daoClass){
        String daoName=daoClass.getClass().getName();
        Set<Object> keys=  redisTemplate.keys(Constant.DAO_CACHE_NAME+"*"+daoName+"*");
        redisTemplate.delete(keys);
    }

    public static void clearServiceByPattern(String pattern){
        Set<Object> keys=  redisTemplate.keys(Constant.SERVICE_CACHE_NAME+"*"+pattern+"*");
        redisTemplate.delete(keys);
    }

    public static void clearServiceByServiceClass(Class serviceClass){
        String serviceName=serviceClass.getClass().getName();
        Set<Object> keys=  redisTemplate.keys(Constant.SERVICE_CACHE_NAME+"*"+serviceName+"*");
        redisTemplate.delete(keys);
    }
