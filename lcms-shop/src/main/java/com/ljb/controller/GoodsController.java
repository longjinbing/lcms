...
@MenuDescription(group="商品中心",name="商品管理", action ="goods/goods.html")
public class GoodsController extends BaseController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        //查询列表数据
        return R.ok().put( goodsService.selectList(params));
    }
    ...
    public R info(@NotNull @PathVariable("id") Long id) {
        ...
        return R.ok().put( BeanUtils.filteBean(goods));
    }
    ...
    public R details(@NotNull @PathVariable("id") Long id) {
        Map<String,Object> goods  = goodsService.selectMapById(id);
        return R.ok().put( goods);
    }
    ...
    public R save(@Validated(AddGroup.class) @RequestBody Goods goods) {
    ...
    public R update(@Validated(UpdateGroup.class) @RequestBody Goods goods) {
    ...
    public void queryAll(@RequestBody JSONObject jsonObject, HttpServletResponse response) {
        goodsService.export(jsonObject,response);
    }
}
